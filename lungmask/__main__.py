...
def main():
    ...
    parser.add_argument('--modelname', help="spcifies the trained model, Default: R231lung1", type=str, choices=['R231lung1','R231','LTRCLobes','LTRCLobes_R231','R231CovidWeb'], default='R231lung1')
